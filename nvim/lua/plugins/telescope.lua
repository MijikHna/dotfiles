return {
  {
    ...
    config = function()
      ...
      keymap.set("n", "<leader>fD", ":Telescope lsp_type_definitions", { desc = "[F]ind LSP {D}eclaration " })
      ...
      keymap.set("n", "<leader>vq", ":Telescope quickfix<CR>", { desc = "[V]iew [Q]uickfix Actions" })
